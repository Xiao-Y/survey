	...
	<body>
		...
		<s:if test="#session['user'] != null">
			<div class="divNavigatorOuterFrame">
				<div class="divNavigatorInnerFrame" style="text-align: right;height: 35px;">
		...
		<table>
			...
			<tr>
				...
				<td class="tdFormControl">
					<input type="text" name="email" class="text" value="xiaoy@.qq.com">
				</td>
			</tr>
			<tr>
				<td class="tdFormLabel">密码:</td>
				<td class="tdFormControl">
					<input type="password" name="password" class="text" value="1">
		...
		<font class="fonterror"><s:actionerror></s:actionerror></font>
		</s:form>
	</body>
</html>